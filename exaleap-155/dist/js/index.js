var gx = function() { "use strict"; "function" == typeof Symbol && Symbol.asyncIterator && (e.prototype[Symbol.asyncIterator] = function() { return this }), e.prototype.next = function(e) { return this._invoke("next", e) }, e.prototype.throw = function(e) { return this._invoke("throw", e) }, e.prototype.return = function(e) { return this._invoke("return", e) };
    ...
    function g(e) { if (Array.isArray(e)) { for (var t = 0, n = Array(e.length); t < e.length; t++) n[t] = e[t]; return n } return Array.from(e) } var r = (t(n, [{ key: "init2dScreen", value: function(e, t) { var n = this.g3d,
            ...
            s.left = "0", s.right = "0", s.top = "0", s.bottom = "0", n.appendChild(o), this.g3dResizeListener = function(e) { r.iv() }, window.addEventListener("resize", this.g3dResizeListener), "function" == typeof a && a(r, i) } }, { key: "load2dScreen", value: function(e, t, n) { var a = this.dm2d,
                ...
                h = this.dm3d,
                u = this.g3d; if (h.clear(), "function" == typeof t && t(u, h), "string" == typeof e) ht.Default.xhrLoad(e, function(e) { if (e) { h.deserialize(e); var t = ht.Default.parse(e),
                        n = ht.Default.clone(t.a),
                        a = d.defaultScene = t.scene; if (u.isOrtho()) { var i = window.htBuildConfig,
                            r = i.eye,
                            o = i.center,
                            s = i.orthoWidth;
                        u.setOrthoWidth(ht.Default.isTouchable ? s.mb : s.pc), u.setEye(ht.Default.isTouchable ? r.mb : r.pc), u.setCenter(ht.Default.isTouchable ? o.mb : o.pc) } else u.setEye(a.eye), u.setCenter(a.center);
                    u.setFar(a.far), u.setNear(a.near), "function" == typeof l && l(u, h, n) } else console.log("资源加载失败") });
            else if (e instanceof ht.Data) { var n = e;
                e = null, h.add(n), this.addNodeChilds(n, h), "function" == typeof l && l(u, h) } } }, { key: "reset2dEvent", value: function(e) { var t = e.miListener,
                n = e.umiListener,
                a = e.mpListener,
                i = e.umpListener,
                r = e.scope;
    ...
    function n() { i(this, n) } var b = { formatDate: function(e, t) { var n = t;
                ...
                function v(e, t) { return e >> t & 1 } return c = new Array(2635, 333387, 1701, 1748, 267701, 694, 2391, 133423, 1175, 396438, 3402, 3749, 331177, 1453, 694, 201326, 2350, 465197, 3221, 3402, 400202, 2901, 1386, 267611, 605, 2349, 137515, 2709, 464533, 1738, 2901, 330421, 1242, 2651, 199255, 1323, 529706, 3733, 1706, 398762, 2741, 1206, 267438, 2647, 1318, 204070, 3477, 461653, 1386, 2413, 330077, 1197, 2637, 268877, 3365, 531109, 2900, 2922, 398042, 2395, 1179, 267415, 2635, 661067, 1701, 1748, 398772, 2742, 2391, 330031, 1175, 1611, 200010, 3749, 527717, 1452, 2742, 332397, 2350, 3222, 268949, 3402, 3493, 133973, 1386, 464219, 605, 2349, 334123, 2709, 2890, 267946, 2773, 592565, 1210, 2651, 395863, 1323, 2707, 265877), f[0] = 0, f[1] = 31, f[2] = 59, f[3] = 90, f[4] = 120, f[5] = 151, f[6] = 181, f[7] = 212, f[8] = 243, f[9] = 273, f[10] = 304, f[11] = 334, e < 1921 || 2020 < e ? "" : (function(e, t, n) { var a, i, r, o, s = !1,
                        l = (u = 3 != arguments.length ? new Date : new Date(e, t, n)).getYear(); for (l < 1900 && (l += 1900), a = 365 * (l - 1921) + Math.floor((l - 1921) / 4) + f[u.getMonth()] + u.getDate() - 38, u.getYear() % 4 == 0 && 1 < u.getMonth() && a++, i = 0;; i++) { for (r = o = c[i] < 4095 ? 11 : 12; 0 <= r; r--) { if (a <= 29 + v(c[i], r)) { s = !0; break }
                            a = a - 29 - v(c[i], r) } if (s) break }
                    d = o - r + 1, h = a, 12 == o && (d == Math.floor(c[i] / 65536) + 1 && (d = 1 - d), d > Math.floor(c[i] / 65536) + 1 && d--) }(e, t = 0 < parseInt(t) ? t - 1 : 11, n), a = "", d < 1 ? (a += "(闰)", a += i.charAt(-d - 1)) : a += i.charAt(d - 1), a += "月", a += h < 11 ? "初" : h < 20 ? "十" : h < 30 ? "廿" : "三十", h % 10 == 0 && 10 != h || (a += "一二三四五六七八九十".charAt((h - 1) % 10)), a) }, prefixInteger: function(e, t) { return (Array(t).join(0) + e).slice(-t) }, randomNumBetween: function(e, t) { var n = t - e,
        ...
        C = { addDevicePanel: function(e, t, l, n) { var d = new ht.Node;
                d.setAnchor3d({ x: "right" === l ? 0 : 1, y: 0, z: .5 }), d.s({ shape3d: "billboard", "shape3d.image": "left" === l ? o.symbolUrl[t] : s.symbolUrl[t], "shape3d.reverse.flip": !0, "shape3d.transparent": !0, "shape3d.vector.dynamic": !0, "shape3d.alwaysOnTop": !0, "select.brightness": 1, interactive: !0, "3d.visible": !1, "3d.selectable": !0, "3d.movable": !1 }), d.setSize3d([200, 80, 1]), d.setScaleX(n), d.setScaleTall(n); var h = new ht.Node; return h.setAnchor3d({ x: "right" === l ? 0 : 1, y: 0, z: .5 }), h.s({ shape3d: "billboard", "shape3d.image": "left" === l ? o.lineSymbol : s.lineSymbol, "shape3d.reverse.flip": !0, "shape3d.transparent": !0, "shape3d.vector.dynamic": !0, "shape3d.alwaysOnTop": !0, "3d.visible": !1, "3d.selectable": !1, "3d.movable": !1 }), h.setSize3d([140, 80, 1]), h.setScaleTall(n), d.onPropertyChanged = function(e) { var t = e.property,
                    ...
                    h = {},
                    u = e.isOrtho(),
                    c = new ht.Math.Vector3(n).sub(new ht.Math.Vector3(d));
                ...
                function r() { a && a(), n.s("3d.visible", !0), e.preClickInfo = { prePanel: n, preClickNode: t, preRestoreFunName: i } } var o = this,
                    ...
                    l = { "楼层地板": function(e, t) { o.restoreFloorStatus(e) } }; if (s) { var d = s.prePanel,
                        h = s.preClickNode,
                        u = s.preRestoreFunName;
                    d.s("3d.visible", !1), l[u] && l[u](h, d), t !== h ? r() : e.preClickInfo = null } else r() } },
        c = { oneWaterWaveAnimate: function(e, t) { var n = t.rectAttrName,
                    a = t.colorAttrName,
                    i = t.initRect,
                    r = t.maxHeight,
                    o = e.a(n),
        ...
        p = { getWireNode: function(e, t, n, a) { var i = new ht.Shape; return i.s({ "all.color": "rgba(" + e + "," + t + ")", "top.color": "rgba(" + e + "," + t + ")", "all.transparent": !0, "all.reverse.cull": !0, "all.reverse.flip": !0, "left.visible": !1, "right.visible": !1, "2d.movable": !1, "3d.movable": !1, "2d.selectable": !1, "3d.selectable": !1 }), i.setTall(n), i.setThickness(a), i.setAnchor3d([.5, .5, .5]), i }, getFloorNode: function(e) { var t = new ht.Shape; return t.s({ "shape3d.color": "rgba(255, 255, 255, 0.01)", "shape3d.top.color": "rgba(255, 255, 255, 0.01)", "shape3d.bottom.color": "rgba(255, 255, 255, 0.01)", "shape3d.transparent": !0, "shape3d.reverse.flip": !0, "shape3d.reverse.cull": !0, "select.brightness": 1, "2d.movable": !1, "3d.movable": !1 }), t.setTall(e), t.setThickness(-1), t.setAnchor3d([.5, .5, .5]), t.setScaleX(.98), t.setScaleY(.98), t }, setDecStatus: function(e, t, n) { var a = ht.Math.Vector3,
                ...
                function l(e, t, n) { var a = function(e, t, n) { var a = d.getWireNode(f(n), v(n), g(n), y(n)); return a.setPoints(e), a.setSegments(N), a.setElevation(t), a }(e, t, n);
                    c.add(a); var i = function(e, t, n) { var a = d.getFloorNode(g(n)); return a.setPoints(e), a.setSegments(N), a.setElevation(t), a }(e, t, n);
                    c.add(i), o && (d.setNodeAnchor3d(r, a, o), d.setNodeAnchor3d(r, i, o)), a.setParent(i), k(n, i, a) } var d = this,
                    h = [],
                    u = [],
                    c = r.dm(),
                    a = e.getColor,
                    ...
                    N = t.getSegments(); if (t.getPoints().each(function(e) { h.push(d.pointTransform(r, t, e)) }), n.getPoints().each(function(e) { u.push(d.pointTransform(r, n, e)) }), 1 === s) { var E = [],
                        S = h[0].y;
                    h.forEach(function(e) { E.push({ x: e.x, y: e.z }) }), l(E, S, 1) } else
                    for (var I = function(e) { for (var t = e / (s - 1), n = [], a = 0; a < P; a++) { var i = new w;
                                i.lerpVectors(h[a], u[a], t), n.push(i) } var r = [],
                                o = n[0].y;
                    ...
                    c = [],
                    f = s.dm();
                t.getPoints().forEach(function(e) { u.push(d.pointTransform(s, t, e)) }), n.getPoints().forEach(function(e) { c.push(d.pointTransform(s, n, e)) });
                ...
                function i(e) { var t = l[e],
                        ...
                        o = [];
                    n.forEach(function(e) { o.push(u[e]) }), a.forEach(function(e) { o.push(c[e]) }), d.setDecStatus(s, i, o), d.setDecStatus(s, r, o), i.a("worldPoint", o), r.a("worldPoint", o), h(e, i, r), f.add(i), f.add(r) } for (var r in l) i(r) } },
        l = { notifyCb: function(e, t) { var n = 0 < arguments.length && void 0 !== e ? e : [],
                    ...
                    s && (l[s][i] = o, this.executeBtnAction(i, o)) } if ("changeEditBuild" === i) { this.editBuildName = { "全楼": "all", "商   场": "business", "办公楼": "office", "停车场": "basement" }[r.a("editBuild1")], this.showBuildByType() } if ("leftToggle" === i) { var d = this.dm2d,
                        h = [];
                    ["panel1", "panel2", "panel3"].forEach(function(e) { var t = d.getDataByTag(e); if (t) { var n = t.a("isVisible");!n && void 0 !== n || h.push(t) } }), C.setNodesStatus(h, { visible: "open" === o }) } if ("rightToggle" === i) { var u = this.dm2d,
                        c = [];
                    ["panel4", "panel5", "panel6"].forEach(function(e) { var t = u.getDataByTag(e); if (t) { var n = t.a("isVisible");!n && void 0 !== n || c.push(t) } }), C.setNodesStatus(c, { visible: "open" === o }) } if ("buildLoaded" === i) { var f = this.dm2d,
                        v = this.dm3d;
                    ...
                    f = r.floorNodes; if (i) { var v = i.prePanel,
                        m = i.preClickNode;
                    C.showPanel(this, m, v) } var g = o.concat(s, l, d, u, c);
                ...
                function i(e) { b.deepTraverseNodes(e, function(e) { e.a("hideBlinkTimes", 0) }), C.setNodesStatus(e, { visible: !0 }) } var o = this,
                    ...
                    d = this.preClickInfo,
                    h = this[l],
                    u = { zj: { onOpen: function() { var e = h.gates,
                                    t = h.gateBlinks;
                ...
                t ? u[e].onOpen() : u[e].onClose() }, startAnimate: function() {
                function e() { o.forEach(function(e) { C.setElevatorFloor(e, 5) }) } var t = this.g2d,
                    ...
                    r = this.all,
                    o = r.elevators;
                e(), this.randomElevatorFloorInterval = setInterval(function() { e() }, 1e3); var s = this.task3d = { interval: 100, action: function(e) { if (-1 < r.alarms.indexOf(e) && c.waterWaveAction(e, [{ rectAttrName: "warnRect1", colorAttrName: "borderColor1", initRect: [4, 99, 292, 102], maxHeight: 254 }, { rectAttrName: "warnRect2", colorAttrName: "borderColor2", initRect: [1.5, 80, 297, 140], maxHeight: 292 }]), -1 < o.indexOf(e) && c.elevatorAnimate(e, 5), e.a("isLoading")) { var t = 5 * Math.PI,
                                n = t / 180,
                                a = e.a("angle") || 0;
                            e.a("angle", (a + n) % (2 * t)) } } };
        ...
        u = function(e) { var t = e.kind,
            ...
            if ("clickData" === t) { this.g3d.isRotatable() && this.g3d.setRotatable(!1); var d = a.getDisplayName(); if (d) { if (-1 < d.indexOf("楼层地板")) { var h = this.preClickInfo,
                            u = this.floorPanel;
                        (h || {}).preClickNode !== a ? this.dataFill.initFloorPassengers(this, a, u) : C.showPanel(this, a, u, null, "楼层地板") }
                    d.indexOf("电梯-") } } if ("onDown" === t && r) { var c = r.displayName; if ("删除" === c) { var f = this.dm3d,
                        v = this.preClickInfo; if (v) { var m = v.prePanel,
                            g = v.preClickNode;
                        g === a && C.showPanel(this, g, m) }
                    f.remove(a) } if ("警报图标" === c && function(e, t) { var n = this.dm3d,
                            ...
                            u = e.p3();
                        h.p3(u), h.setSize({ width: Math.abs(s - e.getX()) }), C.showPanel(this, e, d) }.call(this, a, "alarmPanel"), "floorUp" === c) { var p = this.preClickInfo,
                        y = this.editBuildName,
                        b = this.floorPanel,
                        k = this[y].floorNodes,
                        w = C.getFloorByFloorId(p.preClickNode, k, { isUp: !0 });
                    this.dataFill.initFloorPassengers(this, w, b) } if ("floorDown" === c) { var P = this.preClickInfo,
                    ...
                    this.dataFill.initFloorPassengers(this, I, E) } } if ("onEnter" === t && "data" === i) { var L = a.getDisplayName(); if (L && (-1 < L.indexOf("告警水波") && a.a("delete-icon-visible", !0), -1 < L.indexOf("楼层地板"))) { var A = this.dm3d.getDataByTag("buildFloorNum"),
                        D = a.getChildAt(0);
                    C.setNodesStatus(A, { visible: !0 }), A.setElevation(a.getElevation()), A.a("floorNum", a.a("floorNum")), D && A.a("floorNumColor", D.s("all.color")) } } if ("onLeave" === t && "data" === i) { var T = a.getDisplayName(); if (T && (-1 < T.indexOf("告警水波") && a.a("delete-icon-visible", !1), -1 < T.indexOf("楼层地板"))) { var x = this.dm3d.getDataByTag("buildFloorNum");
                    C.setNodesStatus(x, { visible: !1 }) } } "onEnter" === t && "comp" === i && "楼层号码" === r.displayName && (this.g2d.getView().style.cursor = "pointer"); "onLeave" === t && "comp" === i && "楼层号码" === r.displayName && (this.g2d.getView().style.cursor = "default") },
        f = function(e) { if ("eye" === e.property) { var t = this.g3d,
                    n = this.dm3d;
                C.sortDm3dData(t, n) } }; var v = function(e) { return 0 <= e && e <= 50 ? "rgb(1, 142, 91)" : 51 <= e && e <= 100 ? "rgb(255, 216, 45)" : 101 <= e && e <= 150 ? "rgb(255, 142, 45)" : 151 <= e && e <= 200 ? "rgb(197, 16, 45)" : 201 <= e && e <= 300 ? "rgb(91, 4, 142)" : 301 <= e ? "rgb(115, 6, 32)" : void 0 },
        m = (t(y, [{ key: "getWeather", value: function(t) { var e = this.methodGetSettings("weather");
    ...
    function y() { i(this, y); var e = window.buildURL,
            ...
            n = e.siteId,
            a = e.ajax;
        this.baseurl = t, this.siteId = n, this.ajax = a } var k = (t(w, [{ key: "initFloorPassengers", value: function(r, o, s) { var l = o.a("floorNum"),
                d = o.a("floorType"),
                e = o.a("info").ID;
            window.buildURL.debug && (e = b.randomNumBetween(0, 1)), s.s("shape3d.image", "symbols/3d-icon/loading.json"), s.a("isLoading", !0), s.p3(b.getP3ByAnchor3d(r.g3d, o, o.a("panelAnchor") ? o.a("panelAnchor") : { x: 0, y: .5, z: 1 })), this.dataSource.getFloorPassengers(e, function(e) { if (!r.preClickInfo || r.preClickInfo.preClickNode === o) { s.s("shape3d.image", "symbols/3d-panel/build-panel/mr-build-panel.json"), s.a("isLoading", !1); var t = (e || {}).totalPassengers;
                ...
                o.a({ temperature: 22, temperature1: r, city: n, pm25Des: i, pm25: a, pm25Color: v(a) }) }) } }, { key: "initWorkOrder", value: function(l) { this.dataSource.getWorkOrder(function(e) { var t = e.data || {},
                    n = t.today,
                    a = t.week,
                    i = n || {},
                    r = i.totalWork,
                ...
                a instanceof Array && 0 < a.length && a.forEach(function(e, t) { e.timePoint; var n = e.totalWork;
                    ...
                    o = t.dayPeak; if (o instanceof Array && 0 < o.length) { var s = o[0],
                        ...
                        u = h.begin,
                        c = h.end;
                    f.a({ begin1: l, end1: d, begin2: u, end2: c }) }
            ...
            this.dataSource.getEquipmentAlarm(function(e) { var t = e.data || [];
                c.alarms.length = 0, n(d), n(h), n(u), t instanceof Array && 0 < t.length && (t.forEach(function(e) { var t = e.floorId,
                        n = C.getFloorByFloorId(t, c.floorNodes); if (n) { var a = n.p3(),
                            i = n.a("floorNum"),
                            r = n.a("floorType"),
                            o = b.getRandomPointInCircle(a[0], a[2], n.getWidth() / 4),
                            s = C.addAlarmNode({ dm3d: l, floorNum: i, floorType: r, attr: e, p3: [o.x, a[1], o.y] }); "basement" === r && d.alarms.push(s), "business" === r && h.alarms.push(s), "office" === r && u.alarms.push(s), c.alarms.push(s) } }), C.sortDm3dData(a, l)) }) } }, { key: "initEmergencyAlarm", value: function(h) { var u = [];
            this.dataSource.getEmergencyAlarm(function(e) { var t = e.data || []; if (t instanceof Array && 0 < t.length) { for (var n = 0, a = t.length; n < a; n++) { var i = t[n],
                            ...
                            l = i.spaceName,
                            d = i.faultName;
                        u.push({ time: o, alarmDetail: s + " " + l, name: d, type: r }) }
                    h.a("dataSource", u), h.a("tableRowIndex", 0), c.scrollAlarmTable(h) } }) } }, { key: "initParkingPlaceStatistics", value: function(n) { this.dataSource.getParkingPlaceStatistics(function(e) { var t = e.data || {};
                ...
                n.a("alarmNum", t.alarmNum), n.a("unhandled", t.unhandled), n.a("handled", t.handled) }) } }, { key: "getFlowVedioToken", value: function(t) { this.dataSource.getFlowVideoToken(function(e) { "function" == typeof t && t(e) }) } }, { key: "destory", value: function() { this.dataSource.destory(), this.dataSource = null } }]), w);

    function w() { i(this, w), this.dataSource = new m } var P = (t(N, [{ key: "loadScreen", value: function(n) { var a = this;
            ...
            e.setOrtho(!0), n.load3dScreen(o + "/" + r, null, function(e, t) { a.init3dNodes(), n.add3dMiEvent(u, a), n.add3dMpEvent(f, a), a.notifier.fire({ kind: "buildLoaded" }) }), n.load2dScreen(o + "/" + i, null, function(e, t) { a.init2dNodes(), n.add2dMiEvent(h, a), a.notifier.fire({ kind: "buildLoaded" }) }) } }, { key: "destory", value: function() { var e = this.dm3d;
            ...
            this.editBuildName = "all", this.buildPanelStatus = { all: { zj: !0, dt: !0, ft: !1, jb: !0, kl: !0 }, basement: { zj: !0, dt: !0, ft: !1, jb: !0, kl: !0 }, business: { zj: !0, dt: !0, ft: !1, jb: !0, kl: !0 }, office: { zj: !0, dt: !0, ft: !1, jb: !0, kl: !0 } }, e.each(function(e) { var t = e.getDisplayName(); "工单面板" === t && (n.panel1 = e).a("notifier", a), "客流量面板" === t && (n.panel2 = e).a("notifier", a), "消防报警面板" === t && (n.panel3 = e).a("notifier", a), "重点区域监控面板" === t && (n.panel4 = e).a("notifier", a), "车位统计面板" === t && (n.panel5 = e).a("notifier", a), "功能面板" === t && (n.panel6 = e).a("notifier", a), "天气面板" === t && (n.weatherPanel = e), "时间面板" === t && (n.timePanel = e), "底部面板" === t && (n.bottomPanel = e), "设置面板" === t && (n.settingPanel = e), "投屏" === t && e.a("notifier", a), "左侧toggle" === t && e.a("notifier", a), "右侧toggle" === t && e.a("notifier", a) }) } }, { key: "init3dNodes", value: function() { var n = this,
                e = this.g3d,
                t = this.dm3d,
                c = this.basement = { gates: [], gateBlinks: [], elevators: [], elevatorLines: [], floorNodes: [], escalators: [], alarms: [] },
                v = this.business = { gates: [], gateBlinks: [], elevators: [], elevatorLines: [], floorNodes: [], escalators: [], alarms: [] },
                f = this.office = { gates: [], gateBlinks: [], elevators: [], elevatorLines: [], floorNodes: [], escalators: [], alarms: [] },
            ...
            this.makeBuilding(), this.initBuildSpaceId(), t.each(function(e) { var t = e.getDisplayName(); "地-商-办" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r, o = e.getChildren().toArray();
                        (n = c.elevatorLines).push.apply(n, g(o)), (a = v.elevatorLines).push.apply(a, g(o)), (i = f.elevatorLines).push.apply(i, g(o)), (r = m.elevatorLines).push.apply(r, g(o)) } if ("电梯集合" === t) { var s, l, d, h, u = e.getChildren().toArray();
                        (s = c.elevators).push.apply(s, g(u)), (l = v.elevators).push.apply(l, g(u)), (d = f.elevators).push.apply(d, g(u)), (h = m.elevators).push.apply(h, g(u)) } }), "地-商" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r = e.getChildren().toArray();
                        (n = c.elevatorLines).push.apply(n, g(r)), (a = v.elevatorLines).push.apply(a, g(r)), (i = m.elevatorLines).push.apply(i, g(r)) } if ("电梯集合" === t) { var o, s, l, d = e.getChildren().toArray();
                        (o = c.elevators).push.apply(o, g(d)), (s = v.elevators).push.apply(s, g(d)), (l = m.elevators).push.apply(l, g(d)) } }), "商-办" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r = e.getChildren().toArray();
                        (n = v.elevatorLines).push.apply(n, g(r)), (a = f.elevatorLines).push.apply(a, g(r)), (i = m.elevatorLines).push.apply(i, g(r)) } if ("电梯集合" === t) { var o, s, l, d = e.getChildren().toArray();
                        (o = v.elevators).push.apply(o, g(d)), (s = f.elevators).push.apply(s, g(d)), (l = m.elevators).push.apply(l, g(d)) } }), "商" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("闸机集合" === t) { var n, a, i = e.getChildren().toArray();
                        (n = v.gates).push.apply(n, g(i)), (a = m.gates).push.apply(a, g(i)) } if ("扶梯集合" === t) { var r, o, s = e.getChildren().toArray();
                        (r = v.escalators).push.apply(r, g(s)), (o = m.escalators).push.apply(o, g(s)) } if ("电梯线集合" === t) { var l, d, h = e.getChildren().toArray();
                        (l = v.elevatorLines).push.apply(l, g(h)), (d = m.elevatorLines).push.apply(d, g(h)) } if ("电梯集合" === t) { var u, c, f = e.getChildren().toArray();
                        (u = v.elevators).push.apply(u, g(f)), (c = m.elevators).push.apply(c, g(f)) } }), "楼层面板" === t && (n.floorPanel = e) }), m.floorNodes = c.floorNodes.concat(v.floorNodes, f.floorNodes), m.elevators.forEach(function(e) { var t = e.getDisplayName().split("-"),
                    n = C.getBeginAndEndFloorIndex(4, t[1], t[2]),
                    a = n.beginIndex,
                    i = n.endIndex;
                ...
                e.setAnchor3d({ x: .5, y: 0, z: .5 }, !0); var r = m.floorNodes[a],
                    ...
                    h = l - d,
                    u = d,
                    c = m.floorNodes[i + 1]; if (c) h += c.getElevation() - c.getTall() / 2 - l;
                else { var f = m.floorNodes[i - 1];
                    h += s - (f.getElevation() + f.getTall() / 2) }
                e.setTall(h), e.setElevation(u) }), C.sortDm3dData(e, t) } }, { key: "makeBuilding", value: function() { var e = this.g3d,
                t = this.dm3d,
                a = this.basement,
                i = this.business,
                r = this.office,
                n = t.getDataByTag("first1"),
                o = t.getDataByTag("first2"),
                s = t.getDataByTag("last2"),
                l = t.getDataByTag("first3"),
                d = t.getDataByTag("last3"),
                h = t.getDataByTag("first4"),
                u = t.getDataByTag("last4"),
                c = t.getDataByTag("first5"),
                f = t.getDataByTag("last5"),
                v = t.getDataByTag("first6"),
                m = t.getDataByTag("last6"),
                g = { x: 476, z: 439 };
            p.makeBuilding(e, n, n, 1, { getColor: function(e) { return "53, 153, 219" }, getOpacity: function(e) { return .71 }, getTall: function(e) { return 14 }, getThickness: function(e) { return 6 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["B4"][e - 1]), t.a("floorType", "basement"), a.floorNodes.push(t) } }, g), p.makeBuilding(e, o, s, 3, { getColor: function(e) { return "53, 153, 219" }, getOpacity: function(e) { return .71 }, getTall: function(e) { return 14 }, getThickness: function(e) { return 6 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["B3", "B2", "B1"][e - 1]), 1 === e ? (t.a("floorType", "basement"), a.floorNodes.push(t)) : (t.a("floorType", "business"), i.floorNodes.push(t)) } }, g), p.makeBuilding(e, l, d, 5, { getColor: function(e) { return 1 === e ? "255, 184, 77" : 2 <= e && e <= 4 ? "194, 133, 43" : "209, 42, 145" }, getOpacity: function(e) { return 1 === e ? 1 : 2 <= e && e <= 4 ? .6 : .85 }, getTall: function(e) { return 14 }, getThickness: function(e) { return 6 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["1F", "2F", "3F", "4F", "5F"][e - 1]), t.a("floorType", "business"), i.floorNodes.push(t) } }, g), p.makeBuilding(e, h, u, 9, { getColor: function(e) { return 1 === e ? "194, 133, 43" : 2 === e ? "255, 184, 77" : "111, 166, 222" }, getOpacity: function(e) { return 1 === e ? .6 : 2 === e ? 1 : .58 }, getTall: function(e) { return 14 }, getThickness: function(e) { return 6 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["6F", "7F", "8F", "9F", "10F", "11F", "12F", "15F", "16F"][e - 1]), 1 === e || 2 === e ? (t.a("floorType", "business"), i.floorNodes.push(t)) : (t.a("floorType", "office"), r.floorNodes.push(t)) } }, g), p.makeBuilding(e, c, f, 6, { getColor: function(e) { return "53, 153, 219" }, getOpacity: function(e) { return .8 }, getTall: function(e) { return 14 }, getThickness: function(e) { return 6 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["17F", "18F", "19F", "20F", "21F", "22F"][e - 1]), t.a("floorType", "office"), r.floorNodes.push(t) } }, g), p.makeBuilding(e, v, m, 2, { getColor: function(e) { return "49, 210, 235" }, getOpacity: function(e) { return .8 }, getTall: function(e) { return 14 }, getThickness: function(e) { return 6 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["23F", "25F"][e - 1]), t.a("floorType", "office"), r.floorNodes.push(t) } }, g) } }, { key: "refresh", value: function() { var e = this,
                t = window.buildURL,
            ...
            r.initTime(o), this.refreshNormalData(), this.refreshAlarmData(), this.normalRefreshInterval = setInterval(function() { e.refreshNormalData() }, n), this.alarmRefreshInterval = setInterval(function() { e.refreshAlarmData() }, a), this.timeInterval = setInterval(function() { r.initTime(o) }, 6e4), this.emergencyAlarmInterval = setInterval(function() { var e = s.a("dataSource");
                e instanceof Array && 4 < e.length && c.scrollAlarmTable(s) }, i) } }, { key: "refreshNormalData", value: function() { var e = this.dataFill,
                t = this.weatherPanel,
                n = this.panel1,
                a = this.panel2,
                i = this.bottomPanel,
                r = this.panel5,
                o = this.panel3;
            e.initWeather(t), e.initWorkOrder(n), e.initVisitors(a), e.initInsidePassengers(i), e.initParkingPlaceStatus(i), e.initParkingPlaceStatistics(r), e.initFireAlarm(o) } }, { key: "refreshAlarmData", value: function() { var e = this.dataFill,
                t = this.bottomPanel;
            e.initEmergencyAlarm(t) } }, { key: "getInfoByNum", value: function(e, t) { if ("office" === e) { if (0 <= t && t < 250) return { color: "rgb(0, 180, 81)", level: 5 }; if (250 <= t && t < 500) return { color: "rgb(115, 204, 52)", level: 4 }; if (500 <= t && t < 750) return { color: "rgb(66, 180, 218)", level: 3 }; if (750 <= t && t < 1e3) return { color: "rgb(255, 183, 27)", level: 2 }; if (1e3 <= t) return { color: "rgb(224, 68, 3)", level: 1 } } if ("business" === e) { if (0 <= t && t < 500) return { color: "rgb(0, 180, 81)", level: 5 }; if (500 <= t && t < 1e3) return { color: "rgb(115, 204, 52)", level: 4 }; if (1e3 <= t && t < 1500) return { color: "rgb(66, 180, 218)", level: 3 }; if (1500 <= t && t < 2e3) return { color: "rgb(255, 183, 27)", level: 2 }; if (2e3 <= t) return { color: "rgb(224, 68, 3)", level: 1 } } if ("basement" === e) { if (0 <= t && t < 50) return { color: "rgb(0, 180, 81)", level: 5 }; if (50 <= t && t < 100) return { color: "rgb(115, 204, 52)", level: 4 }; if (100 <= t && t < 150) return { color: "rgb(66, 180, 218)", level: 3 }; if (150 <= t && t < 200) return { color: "rgb(255, 183, 27)", level: 2 }; if (200 <= t) return { color: "rgb(224, 68, 3)", level: 1 } } } }]), N);

    function N(e) { i(this, N), this.dataFill = new k, this.notifier = e, this.notifier.add(l.notifyCb.bind(this, ["zj", "dt", "ft", "jb", "kl"])), this.showBuildByType = l.showBuildByType, this.executeBtnAction = l.executeBtnAction, this.startAnimate = l.startAnimate, this.addPropertyChangeListener = l.addPropertyChangeListener, this.allPanelStatus = { alarmPanel: { scale: 3, leftX: -300, rightX: 850 }, escalatorPanel: { scale: 3, leftX: -300, rightX: 850 }, elevatorPanel: { scale: 3, leftX: -300, rightX: 850 }, gatePanel: { scale: 3, leftX: -300, rightX: 850 } } }
