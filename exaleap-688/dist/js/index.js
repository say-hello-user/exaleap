var gx = function() { "use strict"; "function" == typeof Symbol && Symbol.asyncIterator && (e.prototype[Symbol.asyncIterator] = function() { return this }), e.prototype.next = function(e) { return this._invoke("next", e) }, e.prototype.throw = function(e) { return this._invoke("throw", e) }, e.prototype.return = function(e) { return this._invoke("return", e) };
    ...
    function n() { i(this, n) } var b = { formatDate: function(e, t) { var n = t;
        ...
        m = { getWireNode: function(e, t, n, a) { var i = new ht.Shape; return i.s({ "all.color": "rgba(" + e + "," + t + ")", "top.color": "rgba(" + e + "," + t + ")", "all.transparent": !0, "all.reverse.cull": !0, "all.reverse.flip": !0, "left.visible": !1, "right.visible": !1, "2d.movable": !1, "3d.movable": !1, "2d.selectable": !1, "3d.selectable": !1 }), i.setTall(n), i.setThickness(a), i.setAnchor3d([.5, .5, .5]), i }, getFloorNode: function(e) { var t = new ht.Shape; return t.s({ "shape3d.color": "rgba(255, 255, 255, 0.01)", "shape3d.top.color": "rgba(255, 255, 255, 0.01)", "shape3d.bottom.color": "rgba(255, 255, 255, 0.01)", "shape3d.transparent": !0, "shape3d.reverse.flip": !0, "shape3d.reverse.cull": !0, "select.brightness": 1, "2d.movable": !1, "3d.movable": !1 }), t.setTall(e), t.setThickness(-1), t.setAnchor3d([.5, .5, .5]), t.setScaleX(.98), t.setScaleY(.98), t }, setDecStatus: function(e, t, n) { var a = ht.Math.Vector3,
                ...
                function l(e, t, n) { var a = function(e, t, n) { var a = d.getWireNode(f(n), v(n), g(n), y(n)); return a.setPoints(e), a.setSegments(N), a.setElevation(t), a }(e, t, n);
                    ...
                    u.add(i), o && (d.setNodeAnchor3d(r, a, o), d.setNodeAnchor3d(r, i, o)), a.setParent(i), k(n, i, a) } var d = this,
                    h = [],
                    c = [],
                    u = r.dm(),
                    a = e.getColor,
                    ...
                    for (var I = function(e) { for (var t = e / (s - 1), n = [], a = 0; a < P; a++) { var i = new w;
                                ...
                                o = n[0].y;
                            n.forEach(function(e) { r.push({ x: e.x, y: e.z }) }), l(r, o, e + 1) }, A = 0; A < s; A++) I(A) }, makeDecShape: function(s, t, n, l, e) { var d = this,
                    a = e.faceCall,
        ...
        c = function(e) { var t = e.kind,
            ...
            if ("clickData" === t) { this.g3d.isRotatable() && this.g3d.setRotatable(!1); var d = a.getDisplayName(); if (d) { if (-1 < d.indexOf("楼层地板")) { var h = this.preClickInfo,
                    ...
                    this.dataFill.initFloorPassengers(this, w, b) } if ("floorDown" === u) { var P = this.preClickInfo,
                        N = this.editBuildName,
                        E = this.floorPanel,
                        S = this[N].floorNodes,
                        I = C.getFloorByFloorId(P.preClickNode, S, { isDown: !0 });
                    this.dataFill.initFloorPassengers(this, I, E) } } if ("onEnter" === t && "data" === i) { var A = a.getDisplayName(); if (A && (-1 < A.indexOf("告警水波") && a.a("delete-icon-visible", !0), -1 < A.indexOf("楼层地板"))) { var L = this.dm3d.getDataByTag("buildFloorNum"),
                        D = a.getChildAt(0);
                    C.setNodesStatus(L, { visible: !0 }), L.setElevation(a.getElevation()), L.a("floorNum", a.a("floorNum")), D && L.a("floorNumColor", D.s("all.color")) } } if ("onLeave" === t && "data" === i) { var x = a.getDisplayName(); if (x && (-1 < x.indexOf("告警水波") && a.a("delete-icon-visible", !1), -1 < x.indexOf("楼层地板"))) { var T = this.dm3d.getDataByTag("buildFloorNum");
    ...
    function w() { i(this, w), this.dataSource = new p } var P = (t(N, [{ key: "loadScreen", value: function(n) { var a = this;
            ...
            this.makeBuilding(), this.initBuildSpaceId(), t.each(function(e) { var t = e.getDisplayName(); "地-办" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r = e.getChildren().toArray();
                        (n = h.elevatorLines).push.apply(n, g(r)), (a = v.elevatorLines).push.apply(a, g(r)), (i = m.elevatorLines).push.apply(i, g(r)) } if ("电梯集合" === t) { var o, s, l, d = e.getChildren().toArray();
                        (o = h.elevators).push.apply(o, g(d)), (s = v.elevators).push.apply(s, g(d)), (l = m.elevators).push.apply(l, g(d)) } }), "办" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("扶梯集合" === t) { var n, a, i = e.getChildren().toArray();
                        (n = v.escalators).push.apply(n, g(i)), (a = m.escalators).push.apply(a, g(i)) } if ("闸机集合" === t) { var r, o, s = e.getChildren().toArray();
                        (r = v.gates).push.apply(r, g(s)), (o = m.gates).push.apply(o, g(s)) } if ("电梯线集合" === t) { var l, d, h = e.getChildren().toArray();
                        (l = v.elevatorLines).push.apply(l, g(h)), (d = m.elevatorLines).push.apply(d, g(h)) } if ("电梯集合" === t) { var c, u, f = e.getChildren().toArray();
                        (c = v.elevators).push.apply(c, g(f)), (u = m.elevators).push.apply(u, g(f)) } }), "楼层面板" === t && (n.floorPanel = e) }), m.floorNodes = h.floorNodes.concat(v.floorNodes), m.elevators.forEach(function(e) { var t = e.getDisplayName().split("-"),
                    n = C.getBeginAndEndFloorIndex(3, t[1], t[2]),
                    a = n.beginIndex,
                    i = n.endIndex;
                ...
                r = t.getDataByTag("last1"),
                o = t.getDataByTag("first2"),
                s = t.getDataByTag("first3"),
                l = t.getDataByTag("first4"),
                d = t.getDataByTag("last4"),
                h = t.getDataByTag("first5"),
                c = t.getDataByTag("last5"),
                u = t.getDataByTag("first6"),
                f = t.getDataByTag("last6"),
                v = { x: 200, z: 344 };
            m.makeBuilding(e, n, r, 3, { getColor: function(e) { return "0, 164, 152" }, getOpacity: function(e) { return .43 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["B3", "B2", "B1"][e - 1]), t.a("floorType", "basement"), t.a("panelAnchor", { x: .35, y: .5, z: .88 }), a.floorNodes.push(t) } }, v), m.makeBuilding(e, o, o, 1, { getColor: function(e) { return "0, 255, 255" }, getOpacity: function(e) { return 1 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["1F"][e - 1]), t.a("floorType", "office"), t.a("panelAnchor", { x: .3, y: .5, z: 1 }), i.floorNodes.push(t) } }, v), m.makeBuilding(e, s, s, 1, { getColor: function(e) { return "0, 255, 255" }, getOpacity: function(e) { return 1 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["2F"][e - 1]), t.a("floorType", "office"), t.a("panelAnchor", { x: .2, y: .5, z: 1 }), i.floorNodes.push(t) } }, v), m.makeBuilding(e, l, d, 9, { getColor: function(e) { return "37, 168, 219" }, getOpacity: function(e) { return .8 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["3F", "4F", "5F", "6F", "7F", "8F", "9F", "10F", "11F"][e - 1]), t.a("floorType", "office"), t.a("panelAnchor", { x: .25, y: .5, z: 1 }), i.floorNodes.push(t) } }, v), m.makeBuilding(e, h, c, 9, { getColor: function(e) { return 9 === e ? "214, 43, 149" : "103, 46, 140" }, getOpacity: function(e) { return 9 === e ? 1 : .7 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["12F", "15F", "16F", "17F", "18F", "19F", "20F", "21F", "22F"][e - 1]), t.a("floorType", "office"), t.a("panelAnchor", { x: .25, y: .5, z: 1 }), i.floorNodes.push(t) } }, v), m.makeBuilding(e, u, f, 4, { getColor: function(e) { return "108, 128, 228" }, getOpacity: function(e) { return .8 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["23F", "25F", "26F", "27F"][e - 1]), t.a("floorType", "office"), t.a("panelAnchor", { x: .25, y: .5, z: 1 }), i.floorNodes.push(t) } }, v) } }, { key: "refresh", value: function() { var e = this,
                t = window.buildURL,
    ...
    function N(e) { i(this, N), this.dataFill = new k, this.notifier = e, this.notifier.add(l.notifyCb.bind(this, ["zj", "dt", "ft", "jb", "kl"])), this.showBuildByType = l.showBuildByType, this.executeBtnAction = l.executeBtnAction, this.startAnimate = l.startAnimate, this.addPropertyChangeListener = l.addPropertyChangeListener, this.allPanelStatus = { alarmPanel: { scale: 3, leftX: -500, rightX: 600 }, escalatorPanel: { scale: 3, leftX: -500, rightX: 600 }, elevatorPanel: { scale: 3, leftX: -500, rightX: 600 }, gatePanel: { scale: 3, leftX: -500, rightX: 600 } } }
