...
window.buildUrl = {
    ...
    headers: {
        ...
        "X-API-Version": 1.0,
        "X-Auth-Token": "741096e045f88d2cd5d287c470fb48b7",
        "X-Client-Site-Id": "zzzze204-00e8-4f26-a1e0-5e20ffe54974",
        "X-Client-Type": "Web"
    },
    ajax: {
        weather: { // 天气
            url: '/{siteId}/weather/city/beijing',
            method: 'GET'
        },
        workOrder: { // 工单数据
            url: '/{siteId}/workorder',
            method: 'GET'
        },
        visitors: { // 客流数据
            url: '/{siteId}/visitors',
        ...
        insidePassengers: { // 场内人员统计
            url: '/{siteId}/total-inside-passengers',
            method: 'GET'
        },
        parkingPlaceStatus: { // 车位统计数据接口
            url: '/{siteId}/parking-place-status',
            method: 'GET'
        },
        emergencyAlarm: { // 紧急报警
            url: '/{siteId}/emergency-alarm',
            method: 'GET'
        },
        temp2: { // 停车场车位统计
            url: '',
        ...
        floorPassengers: { // 单个楼层客流统计数据
            url: '/{floorId}/inside-passengers',
            method: 'GET'
        },
        equipmentAlarm: { // 设备警报
            url: '/{siteId}/equipment-alarm',
            method: 'GET'
        },
    },
    dimensionInfo: {
        ...
        "Building": [ // 樓宇下的building列表
            ...
            },
            {
                ...
                "Floor": [ // 商业楼层
                    {
                        "ID": "c0b110e1-a35f-45bf-bdb8-9749437c8e57",
                        "Name": "Basement-02 Floor"
                    },
                    {
                        "ID": "506b81de-9e75-4947-b167-3bf5a9c48ad0",
            ...
            {
                "ID": "2dab5680-fcd5-4601-a34d-b097fd189165",
                "Name": "Office",
                "Floor": [ // 办公楼
                    {
            ...
            {
                "ID": "444c818a-aac4-4aef-a5a9-f98fe5011508",
                "Name": "Equipment",
                "Floor": [ // 顶楼设备
                    {
                        "ID": "08f80c82-db61-4b31-8e8e-90eb3af4dc5a",
                        "Name": "Equipment-23 Floor"
                    },
                    {
                        "ID": "088c0c46-6200-44bb-a248-165a911f7833",
                        "Name": "Equipment-24 Floor"
                    }
                ]
            }
        ]
