var gx = function() { "use strict"; "function" == typeof Symbol && Symbol.asyncIterator && (e.prototype[Symbol.asyncIterator] = function() { return this }), e.prototype.next = function(e) { return this._invoke("next", e) }, e.prototype.throw = function(e) { return this._invoke("throw", e) }, e.prototype.return = function(e) { return this._invoke("return", e) };
    ...
    function w() { i(this, w), this.dataSource = new p } var P = (t(N, [{ key: "loadScreen", value: function(n) { var a = this;
            ...
            this.makeBuilding(), this.initBuildSpaceId(), t.each(function(e) { var t = e.getDisplayName(); "地-商-办" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r, o = e.getChildren().toArray();
                        (n = c.elevatorLines).push.apply(n, g(o)), (a = f.elevatorLines).push.apply(a, g(o)), (i = v.elevatorLines).push.apply(i, g(o)), (r = m.elevatorLines).push.apply(r, g(o)) } if ("电梯集合" === t) { var s, l, d, h, u = e.getChildren().toArray();
                        (s = c.elevators).push.apply(s, g(u)), (l = f.elevators).push.apply(l, g(u)), (d = v.elevators).push.apply(d, g(u)), (h = m.elevators).push.apply(h, g(u)) } }), "地-商" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r = e.getChildren().toArray();
                        (n = c.elevatorLines).push.apply(n, g(r)), (a = f.elevatorLines).push.apply(a, g(r)), (i = m.elevatorLines).push.apply(i, g(r)) } if ("电梯集合" === t) { var o, s, l, d = e.getChildren().toArray();
                        (o = c.elevators).push.apply(o, g(d)), (s = f.elevators).push.apply(s, g(d)), (l = m.elevators).push.apply(l, g(d)) } }), "商-办" === t && e.getChildren().each(function(e) { var t = e.getDisplayName(); if ("电梯线集合" === t) { var n, a, i, r = e.getChildren().toArray();
                        ...
                        (o = f.elevators).push.apply(o, g(d)), (s = v.elevators).push.apply(s, g(d)), (l = m.elevators).push.apply(l, g(d)) } }), "商" === t && e.getChildren().each(function(e) { if ("扶梯集合" === e.getDisplayName()) { var t, n, a = e.getChildren().toArray();
                        (t = f.escalators).push.apply(t, g(a)), (n = m.escalators).push.apply(n, g(a)) } }), "楼层面板" === t && (n.floorPanel = e) }), m.floorNodes = c.floorNodes.concat(f.floorNodes, v.floorNodes), m.elevators.forEach(function(e) { var t = e.getDisplayName().split("-"),
                ...
                u = t.getDataByTag("first4"),
                c = t.getDataByTag("last4"),
                f = { x: -200, z: 500 };
            v.makeBuilding(e, n, o, 2, { getColor: function(e) { return "53, 155, 219" }, getOpacity: function(e) { return .35 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["B2", "B1"][e - 1]), t.a("floorType", "basement"), a.floorNodes.push(t) } }, f), v.makeBuilding(e, s, l, 3, { getColor: function(e) { return 3 === e ? "186, 17, 90" : "145, 145, 145" }, getOpacity: function(e) { return 3 === e ? .89 : .71 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["1F", "2F", "3F"][e - 1]), t.a("floorType", "business"), i.floorNodes.push(t) } }, f), v.makeBuilding(e, d, h, 11, { getColor: function(e) { return "53, 155, 219" }, getOpacity: function(e) { return 11 === e ? .75 : .35 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["4F", "5F", "6F", "7F", "8F", "9F", "10F", "11F", "12F", "15F", "16F"][e - 1]), t.a("floorType", "office"), r.floorNodes.push(t) } }, f), v.makeBuilding(e, u, c, 11, { getColor: function(e) { return 11 === e ? "30, 187, 212" : "49, 210, 235" }, getOpacity: function(e) { return 11 === e ? .9 : .64 }, getTall: function(e) { return 20 }, getThickness: function(e) { return 10 }, floorCall: function(e, t, n) { t.setDisplayName("楼层地板"), t.a("floorNum", ["17F", "18F", "19F", "20F", "21F", "22F", "23F", "25F", "26F", "27F", "28F"][e - 1]), t.a("floorType", "office"), r.floorNodes.push(t) } }, f) } }, { key: "refresh", value: function() { var e = this,
                t = window.buildURL,
    ...
    function N(e) { i(this, N), this.dataFill = new k, this.notifier = e, this.notifier.add(l.notifyCb.bind(this, ["zj", "dt", "ft", "jb", "kl"])), this.showBuildByType = l.showBuildByType, this.executeBtnAction = l.executeBtnAction, this.startAnimate = l.startAnimate, this.addPropertyChangeListener = l.addPropertyChangeListener, this.allPanelStatus = { alarmPanel: { scale: 3, leftX: -600, rightX: 1350 }, escalatorPanel: { scale: 3, leftX: -600, rightX: 1350 }, elevatorPanel: { scale: 3, leftX: -600, rightX: 1350 }, gatePanel: { scale: 3, leftX: -600, rightX: 1350 } } }
